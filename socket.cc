...
Socket::ptr Socket::CreateUCP(sylar::Address::ptr address) {
...
int64_t Socket::getSendTimeout() {
	FdCtx::ptr ctx = FdMgr::GetInstence()->get(m_sock);
	if(ctx) {
...
bool Socket::init(int sock) {
	FdCtx::ptr ctx = FdMgr::GetInstence()->get(sock);
...
bool Socket::cancelAll() {
	return IOManager::GetThis()->canceAll(m_sock);
}
